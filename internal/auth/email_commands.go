...
func SendEmailValidationOTPCommandHandler(ctx context.Context, command SendEmailValidationOTPCommand, saver EventSaver, retriever EventRetriever, sender EmailSender) error {
...
func SendPasswordResetEmailCommandHandler(ctx context.Context, command SendPasswordResetEmailCommand, saver EventSaver, retriever EventRetriever, sender EmailSender, appURL string) error {
