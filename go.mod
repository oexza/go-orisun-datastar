module github.com/example/hono-event-starter-go
...
require (
	...
	github.com/hookenz/gotailwind/v4 v4.3.0 // indirect
	...
	github.com/sqlc-dev/plugin-sdk-go v1.23.0 // indirect
...
tool (
	...
	github.com/delaneyj/toolbelt/sqlc-gen-zombiezen
